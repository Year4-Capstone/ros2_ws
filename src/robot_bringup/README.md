...
Launch the robot in Gazebo simulation with Nav2 navigation stack.
...
### 3. SLAM Launch (ibex_slam.launch.py)

Launch the robot in simulation with SLAM mapping.

```bash
ros2 launch robot_bringup ibex_slam.launch.py
```
...
│   └── ibex_slam.launch.py              # Simulation + SLAM launch file
├── maps/
│   ├── cave_world/
│   │   ├── map.pgm
│   │   └── map.yaml
